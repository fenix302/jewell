...
<%--     <script src="${context}/js/plugins/dataTables/jquery.dataTables.js"></script> --%>
	...
	function fn_delete(){
		...
		if(confirm("정말 글을 삭제하시겠습니까?")){
			location.href = "${context}/work/generalboard/deleteBoard.do?boardNo=" + boardNo;
		}
	}
	...
	function fn_update(){
		...
		location.href = "${context}/work/generalboard/updateBoard.do?boardNo=" + boardNo;
	}

	//목록으로
	function fn_moveToBoard(){
		location.href = "${context}/work/generalboard/retrieveBoardList.do";
	}
</script>
<style type="text/css">
li{
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$("button[data-oper='modify']").on("click", function (e) {
			operForm.attr("action", "${context}/work/generalboard/updateBoard.do?bno=${dsBoard.BNO}").submit();
		});
		...
		$("button[data-oper='list']").on("click", function (e) {
			...
			operForm.attr("action", "${context}/work/generalboard/retrieveBoardList.do")
			operForm.submit();
		});
	});	
</script>	
