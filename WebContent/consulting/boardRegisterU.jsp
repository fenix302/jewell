        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
					...
					<form role="form" action="/work/consulting/updateBoard.do" method="post">	
...
<%-- 						<input type="hidden" name="type" value='<c:out value="${cri.type}"/>'> --%>
						...
						<button id="buttons" type="submit" data-oper='modify' class="btn btn-dark" onclick="location.href=${context}/work/comm/updateBoard.do?bno=${dsBoard.BNO}">수정</button>	
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$('button').on("click", function (e) {
			...
			if (operation === 'remove') {
				formObj.attr("action", "/work/consulting/deleteBoard.do");
				
				// 만약 사용자가 'list' 버튼을 클릭한다면
			} else if (operation === 'list') {
// 				move to list : 아래 두 줄 코딩
				self.location = "${context}/work/consulting/retrieveBoardList.do";
				return;
