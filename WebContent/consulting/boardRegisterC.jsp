...
<div class="page_header">
	...
	<form id="createBoard" method="post" action="/work/consulting/createBoard.do" role="form">
		<div class="form-horizontal">
			...
			<div class="form-group">
				<label for="boardWriter" class="control-label col-md-1"><b>상담사</b></label>
				<div class="col-md-11">
					<input class="form-control" type="text" name="writer" id="writer" required="required" maxlength="50" disabled="disabled" value="JEWELL MANAGER"/>
				</div>
			</div>
