...
<div class="container" style="margin-top: 2%; margin-bottom: 10%;">
	...
	<!-- 			tables.html 소스에서 가져오고, 컨트롤 + 쉬프트 + F 로 정렬 처리		 -->
		...
		<form id="actionForm" action="/work/consulting/retrieveBoardList.do" method="get">
			...
			$(document).ready(
					function() {
						...
						$("#regBtn").on("click", function() {
							self.location = "/work/consulting/createBoard.do";
						});
						...
						$(".move").on("click", function (e) {
							...
							actionForm.attr("action","/work/consulting/retrieveBoard.do");
							actionForm.submit();
						});
