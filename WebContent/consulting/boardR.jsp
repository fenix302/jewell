...
<%--     <script src="${context}/js/plugins/dataTables/jquery.dataTables.js"></script> --%>
	...
	function fn_delete(){
		...
		if(confirm("정말 글을 삭제하시겠습니까?")){
			location.href = "${context}/work/consulting/deleteBoard.do?boardNo=" + boardNo;
		}
	}
	...
	function fn_update(){
		...
		location.href = "${context}/work/consulting/updateBoard.do?boardNo=" + boardNo;
	}

	//목록으로
	function fn_moveToBoard(){
		location.href = "${context}/work/consulting/retrieveBoardList.do";
	}
</script>
<style type="text/css">
li{
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
					...
					<div class="form-group">
							<label>상담사</label> <input class="form-control" name="writer" value= "JEWELL MANAGER" disabled="disabled"/>
					</div>
					...
					<form id="operForm" action="/consulting/boardRegisterU" method="get">
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$("button[data-oper='modify']").on("click", function (e) {
			operForm.attr("action", "${context}/work/consulting/updateBoard.do?bno=${dsBoard.BNO}").submit();
		});
		...
		$("button[data-oper='list']").on("click", function (e) {
			...
			operForm.attr("action", "${context}/work/consulting/retrieveBoardList.do")
			operForm.submit();
		});
	});	
</script>	
